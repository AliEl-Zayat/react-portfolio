      ...
      <Container className="home-content">
        <div className="landing">
          ...
          <div className="landing-icons d-flex gap-4">
            <a
              href="https://www.tiktok.com/@zayat97"
              className="icon"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.facebook.com/ali.elzayat.9619/"
              className="icon"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.instagram.com/ali.elzayat.9619/"
              className="icon"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.linkedin.com/in/ali-el-zayat-736061149/"
              className="icon"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://github.com/AliEl-Zayat"
              className="icon"
              target="_blank"
              rel="noreferrer"
            >
