      ...
      <Row>
        ...
        <Col className="text-white">
          <Fade direction="right" triggerOnce="true">
            <strong className="accent-clr jtitle">Front End Delveloper</strong>
            <br />
            <em className="statement">
              Front-End Developer uses React as a frontend Libaray,Redux for
              Global state management and besides Bootstrap,ChakraUI,MUI and
              other Libaray for CSS.
            </em>
        ...
        <Row>
          ...
          <Col lg="3" md="6" sm="12">
            <div className="dcard">
              ...
              <p className="accent-clr" id="happSup">
                Happy Supported
              </p>
            </div>
          </Col>
