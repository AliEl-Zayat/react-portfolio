  ...
  return (
    <VerticalTimeline>
      <VerticalTimelineElement
        ...
        icon={<MdWork />}
      >
        <h3 className="vertical-timeline-element-title">Frot-end Developer</h3>
        <h4 className="vertical-timeline-element-subtitle">
          HTML5 - CSS3 - Javascript - React JS
        </h4>
        <p>
          User Experience, Visual Designs, Effectient Worker and Committed
          person
        </p>
      </VerticalTimelineElement>
      <VerticalTimelineElement
      ...
      >
        <h3 className="vertical-timeline-element-title text-black">
          Arduino Multi -Tasking Armed Robot{" "}
        </h3>
      ...
      >
        <h3 className="vertical-timeline-element-title text-black">
          Oracle DB for student
        </h3>
        <h4 className="vertical-timeline-element-subtitle text-black">
          Cloud Orcale Database
        </h4>
        <p className="text-black">Cloud Platform , Database</p>
      </VerticalTimelineElement>
      <VerticalTimelineElement
        className="vertical-timeline-element--work"
        date="2018 - 2019"
