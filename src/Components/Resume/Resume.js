  ...
  return (
    <Container>
      <HeadingOfSection
        ...
        sectionPara="You can check my cv here"
      />
      <Fade direction="up" cascade triggerOnce="true">
        <a
          href="https://drive.google.com/file/d/15Cq4k_sOyNJf68OkfNav3vnN0ooET6QW/view?usp=drivesdk"
          target="_blank"
          className="btn btn-outline-info my-btn w-25 mx-auto d-block mb-5"
          rel="noreferrer"
        >
          Download
        </a>
      ...
      <HeadingOfSection
        ...
        sectionPara="LEARN MORE ABOUT MY Education"
      />
      <TimeLine />
      <HeadingOfSection
        sectionName="Skills"
        sectionPara="LEARN MORE ABOUT MY SKILLS"
      />
      <Row>
        {skills.map((skill) => (
            ...
            <Fade direction="up" cascade triggerOnce="true">
              <div className="skill">
                ...
                <div className="probar">
                  <span
                    id="percent"
                    className="skill-progbar active"
                    style={{
                      transition: "1s 0.5s width ease-in",
      ...
      <Row>
        <HeadingOfSection
          className="my-5"
          sectionName="Hoppies"
          sectionPara="LEARN MORE ABOUT MY Hoppies"
        />
